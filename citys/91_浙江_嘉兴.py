...
def parse_kind(kind):
    ...
    for i in range(1, page + 1):
        header = {
            ...
            "Cookie": "ASP.NET_SessionId=dlt1arkh1mtf50vsdhcrixjf",
            "Host": "www.jepb.gov.cn",
            "Origin": "http",
            "Referer": "http",
            "Upgrade-Insecure-Requests": "1",
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/63.0.3239.132 Safari/537.36"
        }
        url = "http://www.jepb.gov.cn/News/NewsList.aspx?ClassID=12"
        data = {
            "__VIEWSTATE": '',
            "__EVENTTARGET": 'ctl00$ContentPlaceHolder3$pager',
            "__EVENTARGUMENT": i,
            "__VIEWSTATEENCRYPTED": "",
            # "__EVENTVALIDATION": "lvquEwKSRSBv1v4l8ABrgzYAiQK4bdgAnLtZwZml0z4=",
        }
        res = requests.post(url, data=data, headers=header)
        html = etree.HTML(res.text)
        # TODO: 解析xpath
        href = html.xpath("//div[@class='list black12']/ul/li//@href")  # url列表
        href = [urljoin(url, i) for i in href]
        title = html.xpath("//div[@class='list black12']/ul/li//*[@href]/text()")  # 标题列表
        time_c = html.xpath("//div[@class='list black12']/ul/li/span[2]/text()")  # 发布日期
        time_c = [get_time(i) for i in time_c]
        if (len(href) == len(title)) and (len(href) == len(time_c)):
            for j in range(len(href)):
                global count
                count += 1
                # 判断类型
                if re.search('验收|竣工', title[j]):
                    continue
                if re.search('受理|许可|报告..{0,1}公[告|示]', title[j]):
                    page_type = 1
                elif re.search('拟', title[j]):
                    page_type = 2
                elif re.search('审批|审查意见|批复', title[j]):
                    page_type = 3
                else:
                    print('@', title[j])
...
def get_page(url):
    ...
    #  TODO: 获取页码
    # 初始化url,获取response
    data = {"__EVENTARGUMENT": '7'}
    res = post_request_text(url, data)
    res = re.search('页码：1/(\d+)', res).group(1)
    return res
...
def run():
    ...
    kinds = [
        # 三类网址的第一个界面的url
        ['http://www.jepb.gov.cn/News/NewsList.aspx?ClassID=12', None],  # 受理
        # ['', 2],  # 拟批
        # ['', 3]  # 已批
    ]
    for i in kinds:
